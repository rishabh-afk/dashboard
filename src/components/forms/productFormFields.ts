...
export const SEOFormFields: FormField[] = [
  ...
  },
  {
    ...
    name: "canonicalUrl",
    label: "Canonical URL",
    placeholder: "Enter Page canonical url",
  },
  {
    rows: 1,
    required: true,
  ...
  },
  {
    ...
    placeholder: "Enter Page og description",
  },
  {
    options: [
      { label: "summary", value: "Summary" },
      { label: "summary_large_image", value: "Summary Large Image" },
      { label: "app", value: "App" },
      { label: "payer", value: "Player" },
    ],
    name: "twitterCard",
    type: "select",
    label: "Twitter Card",
    placeholder: "Select twitter card",
  },
  {
    name: "twitterImage",
    label: "Twitter Image",
    type: "text",
    placeholder: "Enter Twitter Image",
  },
  {
    rows: 1,
    maxLength: 255,
    ...
    name: "twitterTitle",
    label: "Twitter Title",
    placeholder: "Enter Page twitter title",
  },
  {
    type: "text",
    name: "twitterDescription",
    label: "Twitter Description",
    placeholder: "Enter Page twitter description",
  },
  {
    rows: 10,
    type: "textarea",
    maxLength: 499,
    name: "structuredData",
    label: "Structured Data (ld+JSON)",
    placeholder: "Enter Page structured Data",
  },
];
...
export const blogFormFields: FormField[] = [
  ...
  },
  {
    ...
    type: "textarea",
    label: "Blog Excerpt",
    placeholder: "Enter blog excerpt (Short Discription)",
  },
  {
    options: [
    ...
    name: "visibility",
    label: "Visibility",
    placeholder: "Select blog visibility",
  },
  {
    options: [
  ...
  },
  {
    ...
    required: true,
    label: "Tags (seperated by commas (,))",
    placeholder: "Enter Blogs Tags (Filter Keywords)",
  },
];
