  ...
  return (
    <div className="pt-[92px]">
      <div className="flex justify-between items-center mx-4 mb-2">
        <p className="font-semibold text-3xl">Manage Stores</p>
        {isButtonAllowedToShow("Create", "Manage Stores", allowedTabs) && (
          <Button
            text="Create Role"
      ...
      <Table
        ...
        isEdit={isButtonAllowedToShow("Edit", "Manage Stores", allowedTabs)}
        isDelete={isButtonAllowedToShow("Delete", "Manage Stores", allowedTabs)}
      />
    </div>
  );
};
