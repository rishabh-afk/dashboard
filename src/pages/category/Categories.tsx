...
const columns = [
  { key: "name", label: "Category Name", isSortable: true },
  { key: "description", label: "Description", isSortable: false },
  { key: "isActive", label: "Active Status", isSortable: true },
  {
    key: "createdAt",
    label: "Created At",
    isSortable: false,
    ...
    <>
      ...
      <>
        <div className="flex justify-between items-center p-4">
          <p className="text-3xl font-semibold">All Categories</p>
          <button
            type="button"
